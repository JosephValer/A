...
const MovilNav = ({showNav, closeNav}:Props) => {
    ...
    return <div>
        ...
        {/* Navlinks */}
        <div className={`text-white ${navOpen} fixed justify-center flex flex-col h-full transform transition-all duration-500 delay-300 w-[80%] sm:w-[60%] space-y-6 z-[1050] `} style={{ backgroundColor: "var(--color-regal-blue)" }}>
            {/* Map through your nav links here */}
            {navLinks.map((link) => {
                return (
